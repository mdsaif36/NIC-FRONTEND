  ...
  return (
    ...
    >
      ...
      <div className="fixed inset-0 pointer-events-none z-0 overflow-hidden bg-[#020205]">
        ...
        <div className="absolute w-[80vw] h-[80vw] sm:w-[60vw] sm:h-[60vw] md:w-[50vw] md:h-[50vw] max-w-[800px] max-h-[800px] min-w-[300px] min-h-[300px] rounded-full bg-[#1A6BF5]/10 -left-[15%] -top-[15%] blur-[120px] sm:blur-[160px] md:blur-[220px]" />
        
        {/* Premium Red Glow (Bottom-Right) */}
        <div className="absolute w-[90vw] h-[90vw] sm:w-[70vw] sm:h-[70vw] md:w-[55vw] md:h-[55vw] max-w-[900px] max-h-[900px] min-w-[350px] min-h-[350px] rounded-full bg-[#EF4444]/10 -right-[15%] -bottom-[15%] blur-[120px] sm:blur-[160px] md:blur-[220px]" />
        
        {/* Purple Depth Blend Transition Glow */}
        <div className="absolute w-[45vw] h-[45vw] rounded-full bg-purple-600/5 left-[30%] top-[20%] blur-[110px] md:blur-[180px]" />
      ...
      <main className="flex-grow relative z-10">
        {currentPage === 'landing' && (
          <>
            ...
            <div className="w-full overflow-hidden select-none pointer-events-none mt-12 mb-20 flex items-center justify-center relative h-20 xs:h-24 sm:h-32 md:h-44 bg-transparent" aria-hidden="true">
              ...
              <span
                ...
                style={{
                  ...
                  fontSize: 'clamp(1.8rem, 9.5vw, 8.5rem)',
                  fontWeight: 900,
